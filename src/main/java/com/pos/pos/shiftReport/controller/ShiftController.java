package com.pos.pos.shiftReport.controller;
...
public class ShiftController {
    ...
    @GetMapping("/current")
    public ResponseEntity<ShiftReportDTO> getCurrentShift() throws Exception {
        return ResponseEntity.ok(shiftReportService.getCurrentShiftInProgress(null));
    }

    @GetMapping("/cashier/{cashierId}/by-date")
    public ResponseEntity<ShiftReportDTO> getCurrentShift(@PathVariable Long cashierId, @RequestParam @DateTimeFormat(iso = DateTimeFormat.ISO.DATE)LocalDateTime dateTime) throws Exception {
        return ResponseEntity.ok(shiftReportService.getShiftByCashierANdDate(cashierId,dateTime));
    }
    ...
    public ResponseEntity<List<ShiftReportDTO>> getShiftReportByBranchId(@PathVariable Long branchId) throws Exception {
        return ResponseEntity.ok(shiftReportService.getAllShiftReportsByBranchIs(branchId));
    }
